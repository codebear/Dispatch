...
*/
	...
	*/
	virtual int used(int i = 0, bool recurse = 0) {
		...
		* noden bÃ¸r sees pÃ¥ som den "samme" som det
		* denne peker pÃ¥.
		*/
...
public:
	...
	*/
	virtual int used(int u = 0, bool recurse = 0) {
		/**
		* Denne havner i et tvilstilfelle hva angÃ¥r 
		* recursiv merking. Men enn sÃ¥ lenge sÃ¥ merker
		* vi bare argumentlisten dersom vi har recurse slÃ¥tt pÃ¥
		*/
